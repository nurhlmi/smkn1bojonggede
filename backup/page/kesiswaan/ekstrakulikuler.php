			...
			<div class="container">
				...
				<div id="dataFoto" class="row">
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card pointer text-white" data-toggle="modal" data-target="#galeri1">
							<div class="card-head img-overlay" style="background-image:url('/img/ekskul/pramuka.jpg')"></div>
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card pointer text-white" data-toggle="modal" data-target="#galeri2">
							<div class="card-head img-overlay" style="background-image:url('/img/ekskul/paskibra.jpg')"></div>
							<div class="card-img-overlay">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card pointer text-white" data-toggle="modal" data-target="#galeri3">
							<div class="card-head img-overlay" style="background-image:url('/img/ekskul/rohis.jpg')"></div>
							<div class="card-img-overlay">
				...
				<div id="dataModal">
					<div class="modal fade" id="galeri1" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
							<div class="modal-content">
								<img src="/img/ekskul/pramuka.jpg" class="img-fluid" />
							</div>
						</div>
					</div>
					<div class="modal fade" id="galeri2" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
							<div class="modal-content">
								<img src="/img/ekskul/paskibra.jpg" class="img-fluid" />
							</div>
						</div>
					</div>
					<div class="modal fade" id="galeri3" tabindex="-1" role="dialog" aria-hidden="true">
						<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
							<div class="modal-content">
								<img src="/img/ekskul/rohis.jpg" class="img-fluid" />
							</div>
						</div>
					</div>
				</div>
